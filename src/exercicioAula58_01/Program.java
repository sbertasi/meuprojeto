 ...
 * informar o número da conta, o nome do titular da conta, e o 
 * valor de depósito inicial que o titular depositou ao abrir a 
 * conta. Este valor de depósito inicial, entretanto, é opcional, 
 ...
 * inicial da conta será, naturalmente, zero. Importante: uma vez 
 * que uma conta bancária foi aberta, o número da conta nunca 
 * poderá ser alterado. Já o nome do titular pode ser alterado 
 * (pois uma pessoa pode mudar de nome por ocasião de casamento, 
 * por exemplo).
 * Por fim, o saldo da conta não pode ser alterado livremente. É 
 * preciso haver um mecanismo para proteger isso. O saldo só 
 ...
 * suficiente para realizar o saque e/ou pagar a taxa. Você deve 
 * fazer um programa que realize o cadastro de uma conta, dando 
 * opção para que seja ou não informado o valor de depósito 
